...
int main(){
	double S, j, n, D, P;
	int opc, unidad_Interes1=0, unidad_Tiempo1=0,
	i=0, error=0;
	...
	verif_S=true, verif_j=true, verif_n=true, verif_D=true, verif_P=true;
	//SELECCION DE VARIABLES
	//var1 = Principal sin descontar
	//var2 = Tasa de interes simple
	//var3 = Tiempo
	//var4 = Descuento simple
	//var5 = Principal descontado
	do{
		cout<<"TEMA: DESCUENTO RACIONAL SIMPLE"<<endl;
		cout<<"Variables disponibles: "<<endl;
		if(!var1){
			cout<<"1.Principal sin descontar"<<endl;}
		if(!var2){
			cout<<"2.Tasa de interes simple"<<endl;}
		if(!var3){
			cout<<"3.Tiempo"<<endl;}
		if(!var4){
			cout<<"4.Descuento simple"<<endl;}
		if(!var5){
			cout<<"5.Principal descontado"<<endl;}
		cout<<"6.CONFIRMAR"<<endl;
		cout<<"\nVariables seleccionadas: "<<endl;
		if(var1==true){
			cout<<"-Principal sin descontar"<<endl;}
		if(var2==true){
			cout<<"-Tasa de interes simple"<<endl;}
		if(var3==true){
			cout<<"-Tiempo"<<endl;}
		if(var4==true){
			cout<<"-Descuento simple"<<endl;}
		if(var5==true){
			cout<<"-Principal descontado"<<endl;}	
	...
	do{
		if(verif_S==false){
			cout<<"Principal sin descontar invalido"<<endl;}
		if(verif_j==false){
			cout<<"Tasa de interes simple invalida"<<endl;}
		if(verif_n==false){
			cout<<"Tiempo invalido"<<endl;}
		if(verif_D==false){
			cout<<"Descuento simple invalido"<<endl;}
		if(verif_P==false){
			cout<<"Principal descontado invalido"<<endl;}
		if(var1==true){
			cout<<"Principal sin descontar: "<<endl;
			cin>>S;
			if(S>0){
	...
	while(i<=1){
		if(var1==false){
			if(var4==true && var5==true){
				S = P+D;
				cout<<"Principal sin descontar: "<<S<<endl;
				var1 = true;
		...
		if(var5==false){
			if(var2==true && (var3==true && var4==true)){
				P = D/(j*n);
				cout<<"Principal descontado: "<<P<<endl;
				var5 = true;
